...
def basic_sigmoid_test(target):
    ...
    test_cases = [
        {"name": "datatype_check", "input": [x], "expected": float, "error": "Datatype mismatch."},
        {
...
def sigmoid_test(target):
    ...
    test_cases = [
        ...
        {"name": "shape_check", "input": [x], "expected": expected_output, "error": "Wrong shape."},
        {
            "name": "equation_output_check",
            "input": [x],
            "expected": expected_output,
...
def normalizeRows_test(target):
    ...
    expected_output = np.array([[0.0, 0.6, 0.8], [0.13736056, 0.82416338, 0.54944226]])
