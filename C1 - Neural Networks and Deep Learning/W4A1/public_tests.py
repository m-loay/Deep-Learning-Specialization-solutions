...
def linear_activation_backward_test(target):
    ...
    expected_output_sigmoid = (expected_dA_prev_sigmoid, expected_dW_sigmoid, expected_db_sigmoid)

    expected_dA_prev_relu = np.array([[0.44090989, 0.0], [0.37883606, 0.0], [-0.2298228, 0.0]])
...
def L_model_backward_test(target):
    ...
    cache_layer_1 = ((A0, W1, b1), Z1)

    A1 = np.random.randn(3, 2)
    W2 = np.random.randn(1, 3)
    b2 = np.random.randn(1, 1)
    Z2 = np.random.randn(1, 2)
    cache_layer_2 = ((A1, W2, b2), Z2)

    caches = (cache_layer_1, cache_layer_2)
