...
def load_data():
    rel_train_path: str = "../../_resources_deep_learning/W4A2/datasets/train_catvnoncat.h5"
    abs_train_path: Path = get_resource_path(rel_train_path)
    train_dataset = h5py.File(str(abs_train_path), "r")
    train_set_x_orig = np.array(train_dataset["train_set_x"][:])  # your train set features
    train_set_y_orig = np.array(train_dataset["train_set_y"][:])  # your train set labels

    rel_test_path: str = "../../_resources_deep_learning/W4A2/datasets/test_catvnoncat.h5"
    abs_test_path: Path = get_resource_path(rel_test_path)
    test_dataset = h5py.File(str(abs_test_path), "r")
...
def L_model_backward(AL, Y, caches):
    ...
    grads["dA" + str(object=L - 1)], grads["dW" + str(L)], grads["db" + str(L)] = (
